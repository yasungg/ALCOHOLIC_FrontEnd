      ...
      <DrinkContent>
        ...
        <div className="contentbox">
          <div>
            ...
            <p>
              · 좋은 재료가 좋은 술맛을 내듯, 국내산 재료만을 사용하여
              정성스럽게 빚어낸 술
            </p>
          ...
          <div>
            <img
              src="https://d38cxpfv0ljg7q.cloudfront.net/admin_contents/detail/fWO1-1668403134296-1Z7A1584.jpg"
              alt="추천술1"
            />
          </div>
        </div>
        <div className="contentbox">
          <div>
            <img
              src="https://d38cxpfv0ljg7q.cloudfront.net/admin_contents/detail/rC0W-1659321041025-0.jpg"
              alt="추천술2"
            />
          </div>
          <div>
            ...
            <p>
              · 새콤달콤한 유자 향 뒤에 고소 담백한 곡물 향을 느낄 수 있는 술
            </p>
            <p>
              · 달콤한 맛이 자연스럽게 사라질 때 쯤 누룩의 고소하고 담백한 맛이
              샤르르
            </p>
            <p>
              · 와플이나 과일 타르트 같은 디저트류와 달콤하게 즐기기 좋은 술
            </p>
            <button
              onClick={() => {
                navigate("/Product/1");
        ...
        <div className="contentbox">
          ...
          <div>
            <img
              src="https://d38cxpfv0ljg7q.cloudfront.net/admin_contents/detail/HJby-1675410687308-1.jpg"
              alt="추천술3"
            />
          </div>
        </div>
