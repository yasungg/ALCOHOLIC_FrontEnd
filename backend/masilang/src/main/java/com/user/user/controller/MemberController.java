...
import com.user.user.dao.MemberDAO;
...
public class MemberController {
    ...
    public ResponseEntity<Boolean> memberUpdate(@RequestBody Map<String, String> updateData) {
        ...
        String updateId = updateData.get("user_id");
        MemberDAO dao = new MemberDAO();
        boolean result = dao.memberUpdate(updatePw, updateName, updateJumin, updateEmail, updatePhone, updateId);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }
}
